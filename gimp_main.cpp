...
static void query (void) 
{
    ...
    gimp_plugin_menu_register("plug-in-harris", "<Image>/Filters/GPU Filters/Corner");
}
    ...
    *return_vals  = values;
    ...
    switch (run_mode) 
	{
        case GIMP_RUN_INTERACTIVE:
            ...
            gimp_get_data("plug-in-harris", &filter_vals);
    ...
    if (run_mode == GIMP_RUN_INTERACTIVE)
      gimp_set_data("plug-in-harris", &filter_vals, sizeof(filter_config));
