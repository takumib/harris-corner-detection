...
#ifndef __MULTI_RES_CPU_HPP__
#define __MULTI_RES_CPU_HPP__

void run_cpu(guchar *image, const int width, const int height, const int channels);

#endif /* __MULTI_RES_CPU_HPP__ */
